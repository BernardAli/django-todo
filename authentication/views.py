...
def register(request):
    if request.method == "POST":
        ...
        if len(password) < 6:
            messages.add_message(request, messages.ERROR, "Password should be atelast 6 messages")
        ...
        messages.add_message(request, messages.SUCCESS, "Account created, you can login")
